...
normalrule {
    ...
    commands = {
        "dd if=%{ins[1]} of=%{outs} bs=128 count=1",
        "dd if=%{ins[3]} of=%{outs} bs=128 seek=1 skip=456 count=16",
        "dd if=%{ins[3]} of=%{outs} bs=128 seek=17 skip=472 count=23",
    }
}
...
normalrule {
    ...
    commands = {
        ...
        "dd if=%{ins[2]} of=%{outs} bs=128 seek=56 skip=495 count=9 conv=notrunc"
    }
}
